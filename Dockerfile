...
RUN wget https://github.com/chrisss404/check-mk-arm/releases/download/2.2.0p17/check-mk-raw-2.2.0p17_0.focal_arm64.deb && dpkg -i check-mk-raw-2.2.0p17_0.focal_arm64.deb
